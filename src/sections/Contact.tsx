...
${form.message}`;
  ...
  return (
    <section id="contact" className="section bg-obsidian relative overflow-hidden">
      <div
        aria-hidden
        className="aurora bg-gold/15"
      ...
      <div className="relative mx-auto max-w-7xl px-6 md:px-10">
        <div className="grid grid-cols-12 gap-10">
          <div className="col-span-12 md:col-span-5">
            ...
            <h2 className="font-display font-light text-5xl md:text-7xl leading-[0.98] tracking-[-0.02em]">
              <SplitText text="Let's talk" />{" "}
              <span className="gold-text italic">
                <SplitText text="numbers." delay={0.15} />
              </span>
            </h2>
            <Reveal delay={0.3}>
              <p className="mt-8 max-w-md text-ivory/65 leading-relaxed">
                Tell us where you are, where you want to be, and a rough
                timeline. We'll respond within one business day with a clear
                read on whether we're the right fit — and if we are, what
